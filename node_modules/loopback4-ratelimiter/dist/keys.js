...
(function (RateLimitSecurityBindings) {
    ...
    RateLimitSecurityBindings.DATASOURCEPROVIDER = core_1.BindingKey.create('sf.security.ratelimit.datasourceProvider');
    RateLimitSecurityBindings.RATELIMITCONFIG = core_1.BindingKey.create('sf.security.rateLimitMiddleware.config');
})(RateLimitSecurityBindings || (exports.RateLimitSecurityBindings = RateLimitSecurityBindings = {}));
