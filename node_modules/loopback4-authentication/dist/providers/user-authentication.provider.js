...
let AuthenticateActionProvider = class AuthenticateActionProvider {
    constructor(getStrategy, getMetadata, setCurrentUser, authUserModel) {
    ...
    async action(request, response) {
        ...
        if (!strategy.authenticate) {
            throw new rest_1.HttpErrors.Unauthorized("Unknown Error" /* AuthErrorKeys.UnknownError */);
        }
        /**
...
exports.AuthenticateActionProvider = AuthenticateActionProvider = tslib_1.__decorate([
    ...
    tslib_1.__param(3, (0, context_1.inject)(keys_1.AuthenticationBindings.USER_MODEL, { optional: true })),
    tslib_1.__metadata("design:paramtypes", [Function, Function, Function, Object])
