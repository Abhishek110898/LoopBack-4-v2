...
let BearerStrategyFactoryProvider = class BearerStrategyFactoryProvider {
    ...
    getBearerStrategyVerifierWithRequest(verifyFn) {
        return async (req, token, cb) => {
            try {
    ...
    getBearerStrategyVerifierWithoutRequest(verifyFn) {
    ...
    getBearerStrategyVerifierDefault(verifyFn) {
...
exports.BearerStrategyFactoryProvider = BearerStrategyFactoryProvider = tslib_1.__decorate([
