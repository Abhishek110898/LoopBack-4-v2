...
export type VerifyFunctionWithRequest = (clientId: string, clientSecret: string | undefined, done: (error: Error | null, client?: IAuthSecureClient | IAuthClient | null, info?: Object | undefined) => void, req?: express.Request) => void;
