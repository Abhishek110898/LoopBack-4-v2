...
(function (Strategies) {
    ...
    (function (Passport) {
        ...
        Passport.COGNITO_OAUTH2_STRATEGY_FACTORY = core_1.BindingKey.create('sf.passport.strategyFactory.cognitoOauth2');
        Passport.COGNITO_OAUTH2_VERIFIER = core_1.BindingKey.create('sf.passport.verifier.cognitoOauth2');
        // SAML strategy
        Passport.SAML_STRATEGY_FACTORY = core_1.BindingKey.create('sf.passport.strategyFactory.saml');
        Passport.SAML_VERIFIER = core_1.BindingKey.create('sf.passport.verifier.saml');
        Passport.AUTH0_STRATEGY_FACTORY = core_1.BindingKey.create('sf.passport.strategyFactory.auth0');
        Passport.AUTH0_VERIFIER = core_1.BindingKey.create('sf.passport.verifier.auth0');
